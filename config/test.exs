...
config :afp, Afp.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "afp_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :afp, AfpWeb.Endpoint,
  ...
  secret_key_base: "9ivMqo82w8iBrfLAd+IyEAUXCFR/lQjEJC+Rj4N1pGkmcbc26MAQy9NFPilXZAmM",
  server: false

# In test we don't send emails
config :afp, Afp.Mailer, adapter: Swoosh.Adapters.Test
