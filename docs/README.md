...
- `demand-repo-control-plane-design.md` - Design contract for demand source repositories, scheduled/manual research runs, human-confirmed gates, product packages, and optional repo-local SQLite.
