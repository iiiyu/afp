...
- **Contexts** (`lib/afp/factory/*`) own all validation, state-transition rules, and event emission. Current contexts: `Opportunities`, `Portfolio`, `Settings` (key/value store), `Events`.
