  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash}>
      <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_420px]">
            ...
            <div class="overflow-x-auto">
              <table class="min-w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                  <tr :for={snapshot <- @snapshots} class="hover:bg-slate-50 dark:hover:bg-slate-950">
        ...
        <aside>
          <.panel title="Add Metrics Snapshot">
            <.form for={@metrics_form} id="metrics-form" phx-submit="create_metrics" class="space-y-2">
              <.input
              ...
              <.input field={@metrics_form[:support_issues]} type="number" label="Support issues" />
