...
- `demand_live.ex` - Demand source repo health, legacy source detection, source-level manual idea/URL handoffs, indexed candidate queues, package verification, research runs, message templates, manual Codex launch handoffs, existing-session follow-ups, legacy demand items, and promotion into apps.
