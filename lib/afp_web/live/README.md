...
- `demand_live.ex` - Demand source repo health, source-level manual idea/URL handoffs, indexed candidate queues, research runs, message templates, manual Codex launch handoffs, legacy demand items, and promotion into apps.
