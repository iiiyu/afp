    ...
    <Layouts.app flash={@flash}>
      <div class="space-y-4">
        <.page_header
          ...
          title="Sessions"
          subtitle="Stopped-session review, session routing, and hook intake diagnostics."
        >
          <:meta>
            <.summary_item title="Review" value={length(@review_sessions)} hint="stopped" />
            <.summary_item title="Unlinked" value={length(@unlinked_sessions)} hint="needs routing" />
            <.summary_item title="Inbox" value={length(@sessions)} hint="observed sessions" />
          </:meta>
        </.page_header>
        ...
        <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_420px]">
          <main class="space-y-4">
            <.panel title="Review Stopped Sessions">
              <:subtitle>
                Stopped work awaiting operator review and evidence.
              </:subtitle>
            ...
            <.panel title="Session Detail Layers">
              <.disclosure
                title="Session Inbox"
                subtitle="Full session list for routing and inspection."
              >
              ...
              <.disclosure title="Recent Hook Events" subtitle="Raw intake diagnostics.">
                <div :if={@hook_events == []}>
          ...
          <aside class="space-y-4">
            <.panel title="Session Actions">
              <.disclosure
                title="Link Session"
                subtitle="Attach an observed session to app and ticket."
                open
              >
                <.form
                  for={@link_form}
                  id="link-session-form"
                  phx-submit="link_session"
                  class="space-y-2"
                >
                  <.input
              ...
              <.disclosure
                title="Create Ticket From Session"
                subtitle="Turn session output into a review ticket."
              >
                <.form
              ...
              <.disclosure title="Unlinked Sessions" subtitle="Sessions that still need routing.">
