...
- `factory/opportunities.ex`, `factory/opportunities/files.ex`, and `factory/opportunities/README.md` - Portable opportunity repo setup, health inspection, repo-local `base.sqlite` reads/writes, Codex launch progress, and (in `files.ex`) the Markdown/image file walk/classify/index/read browser.
